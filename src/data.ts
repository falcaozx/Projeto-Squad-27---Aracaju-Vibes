...
import caririImg from "../assests/cariri.png";
...
export const restaurants: Restaurant[] = [
  ...
  {
    id: "r6",
    name: "Cariri Restaurante e Casa de Forró",
    cuisine: "Regional nordestina • frutos do mar, pratos típicos e forró",
    address: "Av. Santos Dumont, 1870 - Atalaia, Aracaju - SE, 49037-475",
    hours: "Diariamente, 10h30 às 02h",
    category: "Regional",
    image: caririImg,
    price: "$$",
    coords: { lat: -10.9914, lng: -37.0416 },
  },
];
...
export const bars: Restaurant[] = [
  {
    ...
    image: barImg,
    price: "$$",
    coords: { lat: -10.912, lng: -37.051 },
  },
  {
    id: "b2",
    name: "Beco do Tropeiro",
    cuisine: "Petiscos & Sertanejo",
    rating: 4.6,
    address: "Atalaia",
    hours: "18h – 02h",
    category: "Bar",
    ...
    image: barImg,
    price: "$$",
    coords: { lat: -11.005, lng: -37.042 },
  },
  {
    id: "b3",
    name: "Studio Pub",
    cuisine: "Cervejaria & Rock",
    rating: 4.7,
    address: "Treze de Julho",
    hours: "18h – 03h",
    category: "Bar",
    liveMusic: true,
    image: barImg,
    price: "$$",
    coords: { lat: -10.933, lng: -37.044 },
  },
  {
    id: "b4",
    name: "Cacique Chá",
    cuisine: "Coquetelaria autoral",
    rating: 4.9,
    address: "Coroa do Meio",
    hours: "17h – 01h",
    category: "Bar",
    liveMusic: false,
    image: barImg,
    price: "$$$",
    coords: { lat: -10.984, lng: -37.038 },
  },
];
...
export const beaches: Beach[] = [
  {
    ...
    short: "A queridinha da capital",
    description:
      "Ondas calmas a fortes, calçadão extenso com pista de cooper, ciclovia, quiosques, parques infantis e o Oceanário. Vida agitada do nascer ao pôr do sol.",
    features: ["Calçadão", "Quiosques", "Esportes", "Família"],
    image: atalaia,
    coords: { lat: -10.976, lng: -37.0465 },
  },
  {
    id: "aruana",
    name: "Praia de Aruana",
    short: "Águas verdes e tranquilas",
    description:
      "Praia familiar com águas mornas e piscinas naturais na maré baixa. Excelente infraestrutura de bares à beira-mar.",
    features: ["Piscinas naturais", "Familiar", "Barracas"],
    image: aruana,
    coords: { lat: -11.0264, lng: -37.0601 },
  },
  {
    id: "mosqueiro",
    name: "Praia do Mosqueiro",
    short: "Sossego à beira-mar",
    description:
      "Refúgio mais ao sul com poucos quiosques, ideal para quem busca tranquilidade. Pôr do sol espetacular sobre o rio Vaza-Barris.",
    features: ["Sossegada", "Pôr do sol", "Pescadores"],
    image: mosqueiro,
    coords: { lat: -11.1215, lng: -37.1235 },
  },
  {
    id: "refugio",
    name: "Praia do Refúgio",
    short: "Natural e selvagem",
    description:
      "Trecho mais preservado, com dunas e vegetação nativa. Ideal para caminhadas e contemplação.",
    features: ["Dunas", "Natureza", "Trilhas"],
    image: aruana,
    coords: { lat: -11.0825, lng: -37.098 },
  },
  {
    id: "naufragos",
    name: "Praia dos Náufragos",
    short: "Surf e juventude",
    description:
      "Ponto preferido dos surfistas locais, ondas mais formadas e ambiente jovem aos finais de semana.",
    features: ["Surf", "Jovem", "Esportes"],
    image: atalaia,
    coords: { lat: -11.065, lng: -37.085 },
  },
];
...
export const attractions: Attraction[] = [
  {
    ...
    price: "Gratuito",
    description:
      "Os famosos arcos coloridos da Orla de Atalaia, ícone visual da cidade e cenário obrigatório para fotos.",
    image: heroOrla,
    coords: { lat: -10.9856, lng: -37.0438 },
  },
  {
    id: "oceanario",
    ...
    price: "R$ 30",
    description:
      "Aquário com espécies da costa sergipana, túnel de vidro e atividades educativas para todas as idades.",
    image: oceanarioNew,
    coords: { lat: -10.9763, lng: -37.0465 },
  },
  {
    ...
    price: "Gratuito",
    description:
      "Polo gastronômico noturno com dezenas de restaurantes especializados em frutos do mar e o famoso caranguejo.",
    image: passarelaNew,
    coords: { lat: -10.9914, lng: -37.0416 },
  },
  {
    ...
    category: "Cultura",
    hours: "Ter–Dom 10h – 17h",
    price: "Gratuito",
    description:
      "Museu interativo que conta a história e cultura do povo sergipano através de tecnologia e instalações imersivas.",
    image: museuNew,
    coords: { lat: -10.9167, lng: -37.0483 },
  },
  {
    id: "mercado-municipal",
    name: "Mercado Municipal",
    category: "Compras",
    hours: "Seg–Sáb 06h – 18h",
    price: "Gratuito",
    description:
      "Tradicional mercado central com artesanato, temperos, frutas, comidas típicas e o famoso licor de jenipapo.",
    image: mercadoNew,
    coords: { lat: -10.9069, lng: -37.0505 },
  },
  {
    id: "croa-gore",
    name: "Croa do Goré",
    ...
    price: "R$ 80 (passeio)",
    description:
      "Banco de areia que aparece na maré baixa em meio ao Rio Vaza-Barris. Almoço em barcos-restaurante.",
    image: croaNew,
    coords: { lat: -11.1272, lng: -37.1355 },
  },
];
...
export const events: EventItem[] = [
  {
    id: "e1",
    title: "Forrobodó de Aracaju",
    artist: "Mestrinho & Convidados",
    date: "14 Jun",
    time: "20:00",
  ...
  {
    id: "e2",
    title: "Forró Caju 2026",
    artist: "Various Artists",
    date: "20 Jun",
    time: "18:00",
    venue: "Orla de Atalaia",
    city: "Aracaju",
    category: "Festival",
    price: 0,
    image: forro,
    coords: { lat: -11.0028, lng: -37.0428 },
  },
  {
    id: "e3",
    ...
    date: "05 Jul",
    time: "22:00",
    venue: "Arena Batistão",
    city: "Aracaju",
    category: "Sertanejo",
    price: 180,
    image: forro,
    coords: { lat: -10.925, lng: -37.058 },
  },
  {
    id: "e4",
    ...
    date: "12 Jul",
    time: "21:00",
    venue: "Beach Stage Atalaia",
    city: "Aracaju",
    category: "Pagode",
    price: 120,
    image: forro,
    coords: { lat: -11.01, lng: -37.045 },
  },
  {
    id: "e5",
    title: "Tropical Electronic",
    artist: "Vintage Culture",
    date: "26 Jul",
    time: "23:00",
    venue: "Hangar Sergipe",
    city: "Aracaju",
    category: "Eletrônica",
    price: 220,
    image: forro,
    coords: { lat: -10.975, lng: -37.05 },
  },
];
